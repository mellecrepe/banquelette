...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('account', '0005_auto_20160112_2302'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='account',
            name='bank',
            field=models.CharField(max_length=50, choices=[(None, b''), (b'oney', b'Oney'), (b'boursorama', b'Boursorama'), (b'soge', b'Soci\xc3\xa9t\xc3\xa9 G\xc3\xa9n\xc3\xa9rale'), (b'ingdirect', b'ING Direct'), (b'banquepopulaire', b'Banque Populaire'), (b'espece', b'Liquide/Esp\xc3\xa8ce')]),
        ),
        migrations.AlterField(
            model_name='account',
            name='category',
